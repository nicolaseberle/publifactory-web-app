...
const webpackConfig = merge(commonConfig, {
    ...
    devServer: {
        ...
        proxy: {
          ...
          '/cursors': { target: `http://${process.env.BASE_API}:4002` + '/cursors', changeOrigin: true, ws: true },
          '/mevn-dev': { target: `http://${process.env.BASE_API}:4002` + '/mevn-dev', changeOrigin: true, ws: true }
        },
        stats: {normale:true}
    }
});
