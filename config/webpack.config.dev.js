...
const webpackConfig = merge(commonConfig, {
    ...
    devServer: {
        ...
        proxy: {
          ...
          '/public': { target: 'http://client_dev:9001',  pathRewrite: {'^/public' : '/client/public'}},
          '/socket.io': { target: `http://${process.env.SITE_IP}:` + backendBase.port, changeOrigin: true, ws: true },
