...
export const constantRouterMap = [
	...
	{
		path: '/invitationSubmission/:journalId/:articleId/:status(accept|reject)',
		component: resolve => {
			import('../view/invitation-submission/').then(resolve);
		}
	},
	{
		path: '/invitationReview/:articleId/:status(accept|reject)',
		component: resolve => {
			import('../view/invitation-review/').then(resolve);
		}
	},
	{
		path: '/summarize',
