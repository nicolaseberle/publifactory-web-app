...
function asideRightAnimation() {
    ...
    // ------------------------------------
    asideRight.pannel.comments.on('click', function () {
    ...
    asideRight.pannel.reviews.on('click', function () {
        asideRight.pannel.links.removeClass("active");
    ...
    asideRight.pannel.article.on('click', function () {
        var markup = $(this).attr("data-review");
        var articleText = $("main article span[data-review='" + markup + "'");
        // Bug Fix - force display the related div
        // ---------------------------------------
        var accordionPannel = articleText.parents("div.accordion-panel").get(0);
...
exports.default = asideRightAnimation;
...
var _TweenMax = require('gsap/src/uncompressed/TweenMax');

var _TweenMax2 = _interopRequireDefault(_TweenMax);

var _TimelineMax = require('gsap/src/uncompressed/TimelineMax');
...
function headerAnimation() {
    ...
    // ----------------------
    var headerPosition = _TweenMax2.default.to("#header", 0, {
        css: {
            position: "fixed",
            top: 0
        },
    ...
    var startHeaderPosition = new _ScrollMagic2.default.Scene({
    ...
    // ------------------------------------------------------------
    var asidePosition = _TweenMax2.default.to("#triggerAside", 0.5, {
        css: {
            position: "fixed",
            top: 100,
    ...
    var startAsidePosition = new _ScrollMagic2.default.Scene({
        triggerElement: "#triggerStartNav",
    ...
    // -----------------------------------------------------
    var mainPosition = _TweenMax2.default.to("#main", 0, {
        css: {
            position: "relative",
            top: 200
        },
    ...
    var startMainPosition = new _ScrollMagic2.default.Scene({
        triggerElement: "#triggerStartNav",
        offset: $(window).height() / 2,
        duration: 0
...
},{"gsap/src/uncompressed/TimelineMax":8,"gsap/src/uncompressed/TweenMax":10,"scrollmagic/scrollmagic/uncompressed/ScrollMagic":11,"scrollmagic/scrollmagic/uncompressed/plugins/animation.gsap":12,"scrollmagic/scrollmagic/uncompressed/plugins/debug.addIndicators":13}],4:[function(require,module,exports){
'use strict';
...
function navAnimation() {
    ...
    // Start animating nav
    // -------------------
    var navStartPosition = _TweenMax2.default.to("#nav", 0.4, {
        css: {
            y: -120
        },
        ease: Linear.easeNone
    });
    var initNavPosition = new _ScrollMagic2.default.Scene({
        triggerElement: "#triggerStartNav",
        offset: $(window).height() / 2 - 80,
        duration: 80
    ...
    // End animating nav
    // -------------------
    var navFinishPosition = _TweenMax2.default.to("#nav", 0, {
        css: {
            position: "absolute",
            left: "0",
            bottom: "-120"
    ...
    var finishNavPosition = new _ScrollMagic2.default.Scene({
...
exports.default = navAnimation;

},{"gsap/src/uncompressed/TimelineMax":8,"gsap/src/uncompressed/TweenMax":10,"scrollmagic/scrollmagic/uncompressed/ScrollMagic":11,"scrollmagic/scrollmagic/uncompressed/plugins/animation.gsap":12,"scrollmagic/scrollmagic/uncompressed/plugins/debug.addIndicators":13}],5:[function(require,module,exports){
"use strict";
...
// --------------------
var smoothScroll = {
    init: function init(target, url, offset, delay, easing) {
        try {
            if ((typeof url === "undefined" ? "undefined" : _typeof(url)) === undefined || url === "#") {
...
var LinkScroll = function () {
    function LinkScroll(target, selector, offset, delay, easing) {
        var _this = this;
    ...
    _createClass(LinkScroll, [{
        key: "scrollIt",
        value: function scrollIt(e) {
            e.preventDefault();
            if (_typeof(this.url) !== undefined || this.url !== "#") {
        ...
        value: function init(parameters) {
            ...
            $(parameters.selector).each(function () {
                LinkScroll.instances.push(new LinkScroll(parameters.target, this, parameters.offset, parameters.delay, parameters.easing));
            });
        }
    }, {
        key: "allInstances",
...
// Function svgInline
// ------------------
// Used to replace all img tag with *.svg src attribute to inline svg tag
// Needed to change color / size and so on
...
var _svgInline = require('./function/svg.inline.js');

var _svgInline2 = _interopRequireDefault(_svgInline);

var _LinkScroll = require('./class/LinkScroll.js');

var _header = require('./animation/header.js');

var _header2 = _interopRequireDefault(_header);

var _nav = require('./animation/nav.js');

var _nav2 = _interopRequireDefault(_nav);

var _accordion = require('./animation/accordion.js');

var _accordion2 = _interopRequireDefault(_accordion);

var _asideRight = require('./animation/aside.right.js');

var _asideRight2 = _interopRequireDefault(_asideRight);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

// Call instances
// --------------
var inst_svgInline = new _svgInline2.default(); // -----------------------
...
var inst_navAnimation = new _nav2.default();
var inst_headerAnimation = new _header2.default();
var inst_accordion = new _accordion2.default();
var inst_asideRightAnimation = new _asideRight2.default();

// Init LinkScroll on every a[href^='#']
// -------------------------------------
_LinkScroll.LinkScroll.init({
    target: "html, body",
    selector: "a[href^='#']",
    offset: 125,
    delay: 800,
...
},{"./animation/accordion.js":1,"./animation/aside.right.js":2,"./animation/header.js":3,"./animation/nav.js":4,"./class/LinkScroll.js":5,"./function/svg.inline.js":6,"gsap/src/uncompressed/TimelineMax":8,"gsap/src/uncompressed/TweenMax":10,"scrollmagic/scrollmagic/uncompressed/ScrollMagic":11,"scrollmagic/scrollmagic/uncompressed/plugins/animation.gsap":12,"scrollmagic/scrollmagic/uncompressed/plugins/debug.addIndicators":13}],8:[function(require,module,exports){
(function (global){
/*!
 * VERSION: 1.20.3
 * DATE: 2017-10-02
...
},{"gsap/TweenLite":9}],9:[function(require,module,exports){
(function (global){
/*!
 * VERSION: 1.20.3
 * DATE: 2017-10-02
...
},{"gsap":10,"scrollmagic":11}],13:[function(require,module,exports){
/*!
 * ScrollMagic v2.0.5 (2015-04-29)
 * The javascript library for magical scroll interactions.
 * (c) 2015 Jan Paepke (@janpaepke)
