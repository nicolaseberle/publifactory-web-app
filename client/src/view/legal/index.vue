<template>
      ...
      <el-row>
          <div class="header">
              ...
              <p>All use of Publifactory web pages located within <i> www.publifactory.com </i>is subject to the terms and conditions set forth below (“Terms”), provided however that additional terms of use may apply with respect to certain PubliFactory websites, as specified on each such website. Any use of such web pages constitutes the user’s agreement to abide by the Terms. We may amend the Terms at any time by posting the amended terms on this site.</p>
