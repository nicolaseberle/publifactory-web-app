<template>
	<div class="login-modal-content">
		<div v-if="active == 'login'">
			...
			<p class="caption">
				<span>or </span
				><a v-on:click="switchRegister" style="color:#00a97f!important;"
					>create an account</a
				>
			</p>
			<el-form class="login-form" ref="form" :model="form" :rules="rules">
				...
				<div class="register" style="float:right">
					<a
						href="/login/forgot"
						style="font-size=0.6rem;text-decoration:underline;text-align:end"
						>Forgot password?</a
					>
				</div>
				<el-button
		...
		<div v-else>
			...
			<p class="caption">
				<span>or </span
				><a v-on:click="switchLogin" style="color:#00a97f!important;"
					>sign in</a
				>
			</p>
			<el-form
