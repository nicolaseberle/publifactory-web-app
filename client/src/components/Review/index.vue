...
<template>
  <div class="wrapper">
      ...
      <section class="content reviews">
          <tree-comment :flagShowingComment='false' :uuidComment="reports.uuidComment" :creationDate="reports.creationDate" :label="reports.content" :anonymousFlag="reports.anonymousFlag" :reviewRequest="reports.reviewRequest" :user="reports.userId" :nodes="reports" v-on:post="reload" :depth="0"></tree-comment>
