...
router.patch(
  '/:id/:status(preprint|submit|review|publish)',
...
router.put(
  ...
  rolesArticle.inviteAe,
  articlesController.addAssociateEditor
)
...
router.put(
  '/:id/updateReferences',
  articlesController.findArticlebyIdAndUpdateReferences
)
